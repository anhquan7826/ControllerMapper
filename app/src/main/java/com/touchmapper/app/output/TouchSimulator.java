...
import com.touchmapper.app.InputEventInjector;
...
public class TouchSimulator {
    InputEventInjector eventInput = new InputEventInjector();
    ...
    public void simulateTouch(int mapId,
        ...
        Log.d("console", "Simulating touch " + originalAction + " in " + x + "," + y + " pointers: " + pointers);
